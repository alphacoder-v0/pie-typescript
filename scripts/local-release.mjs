...
const packages = [
	{ directory: "packages/ai", name: "@pie/ai" },
	{ directory: "packages/tui", name: "@pie/tui" },
	{ directory: "packages/agent", name: "@pie/agent-core" },
	{ directory: "packages/coding-agent", name: "@pie/coding-agent" },
];
