...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@pie/coding-agent";
...
```typescript
import { createAgentSession, SessionManager } from "@pie/coding-agent";
...
The `Agent` class (from `@pie/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@pie/coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@pie/coding-agent";
...
```typescript
import { createAgentSession } from "@pie/coding-agent";
...
import { createAgentSession, defineTool } from "@pie/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@pie/coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@pie/coding-agent";
