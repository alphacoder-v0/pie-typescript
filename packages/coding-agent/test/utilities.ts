...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@pie/ai";
...
// ============================================================================
// OAuth API key resolution from ~/.pie/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pie", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pie/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pie/auth.json
 */
...
/** Path to the real pie agent config directory */
export const PI_AGENT_DIR = join(homedir(), ".pie");

/**
 * Get an AuthStorage instance backed by ~/.pie/auth.json
