...
import { ENV_AGENT_DIR, ENV_BASE_DIR, PACKAGE_NAME, VERSION } from "../src/config.ts";
...
describe("package commands", () => {
	...
	beforeEach(() => {
		...
		originalBaseDir = process.env[ENV_BASE_DIR];
	...
	afterEach(() => {
		...
		if (originalBaseDir === undefined) {
			...
			process.env[ENV_BASE_DIR] = originalBaseDir;
		}
