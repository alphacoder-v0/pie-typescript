import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@pie/coding-agent";
import type { Component, EditorTheme, TUI } from "@pie/tui";
import { truncateToWidth, visibleWidth } from "@pie/tui";
